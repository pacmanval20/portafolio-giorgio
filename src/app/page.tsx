...
export default function Home() {
  ...
  return <><a className="skip-link" href="#contenido">Saltar al contenido</a><Navbar /><ProgrammerEffects /><main id="contenido"><HeroSection /><ServicesGrid /><Projects /><AboutUs /><ContactWhatsapp /><FaqAccordion /></main><Footer /><SaveShortcutGuard /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData).replace(/</g, '\\u003c') }} /></>;
}
