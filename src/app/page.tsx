...
export default function Home() {
  ...
  return <><a className="skip-link" href="#contenido">Saltar al contenido</a><Navbar /><ProgrammerEffects /><main id="contenido"><HeroSection /><div className="stack-band"><div className="container"><span>APRENDIZAJE EN MOVIMIENTO</span><p>Java <i>/</i> JavaScript <i>/</i> Python <i>/</i> HTML & CSS <i>/</i> Linux</p><span aria-hidden="true">↓</span></div></div><ServicesGrid /><Projects /><AboutUs /><FaqAccordion /><ContactWhatsapp /></main><Footer /><SaveShortcutGuard /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData).replace(/</g, '\\u003c') }} /></>;
}
